    ...
    <div className="nav-item absolute right-5 md:right-40 top-16 bg-white dark:bg-[#42464D] p-8 rounded-lg w-96">
      <div className="flex justify-between items-center">
        <div className="flex gap-3">
          ...
          <button type="button" className="text-green-300 text-xs rounded p-1 px-2"> 5 Novas</button>
        </div>
        <button
          type="button"
      ...
      <div className="mt-5 ">
        ...
        <div className="mt-5">
          <Button color="white" bgColor={currentColor} text="Ver todas notificações" borderRadius="10px" width="full" />
        </div>
      </div>
    </div>
  );
